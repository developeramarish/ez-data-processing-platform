...
const AggregationHelper: React.FC<AggregationHelperProps> = ({
  ...
  }, [timeWindow, customDuration, groupingField, maxGroups, showOthers, sortBy, rollingWindow, lookbackPeriod, alignment]); // Removed onSettingsChange from deps to prevent infinite loop
