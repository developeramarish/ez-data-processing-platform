...
| **Messaging** | Kafka + MassTransit | - | Event-driven communication |
...
│   • DataSource Management (1)          • Kafka (2 brokers)              │
...
| **Medium** | Kafka replication factor | ⚠️ Dev only | Increase to 3+ for production |
